    ...
    <section class="infoPerfil">
        <header>
            ...
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400" style="color: #D1D1D1;">
                {{ __('Asegurate de usar una contraseña larga para mayor seguridad.') }}
            </p>
        </header>
        ...
        <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
            ...
            <div>
                <x-input-label for="update_password_current_password" style="color: #fff;" :value="__('Contraseña Actual')" />
            ...
            <div>
                <x-input-label for="update_password_password" style="color: #fff;" :value="__('Nueva Contraseña')" />
            ...
            <div>
                <x-input-label for="update_password_password_confirmation" style="color: #fff;" :value="__('Confirmar Contraseña')" />
